...
작성: 2026-05-09 (v1.2 정렬: 2026-05-09 KST 후반)
상태 기준: PRD v1.2 + CURATION_CHOREOGRAPHY_SPEC + FINAL_ALIGNMENT (2026-05-08 override v1.2 §1로 정식 승격) + 본 세션 진단
...
2. **보안 2축 (v1.2 §6)**: 의료 도메인 어휘 차단 폐기 (정상 비즈니스 도메인). PIPA(M0/M1 scanner) + prompt injection 3-layer(`packages/shared/src/security/`)로 재정의.
