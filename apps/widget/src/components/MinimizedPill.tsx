...
export function MinimizedPill(props: MinimizedPillProps): JSX.Element {
  return (
    <motion.button
      ...
      className="pointer-events-auto fixed bottom-5 right-5 z-[90] flex items-center gap-2 rounded-full border border-black/10 bg-white/95 px-3 py-2 text-[12px] font-bold text-ink shadow-[0_7px_18px_rgba(7,20,39,0.10)] backdrop-blur hover:border-accent/40"
